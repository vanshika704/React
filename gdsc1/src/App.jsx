...
function Logincard() {
  return (
      ...
      <div className="card"  style={{ height: 500, width: 400, alignContent: 'center', marginLeft: 500}}>
        <div className="card-body" style={{ marginLeft:70}}>
          <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
              <img className="mx-auto" src={logo} alt="Your Company" style={{ height: '80px', width: '80px' }} />
